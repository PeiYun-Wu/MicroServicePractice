...
namespace Mango.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : Controller
    {
       ...
       protected ResponseDto _response;
        ...
        [HttpPost("Checkout")]
        public async Task<object> Checkout(CheckoutHeaderDto checkoutHeader)  //for網頁的order 不連DB
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(checkoutHeader.CouponCode))
                {
                    ...
                    if (checkoutHeader.DiscountTotal != coupon.DiscountAmount) //被改過  coupon過的了再取消註解
                    {
                        _response.IsSuccess = false;
                ...
                // await _messageBus.PublishMessage(checkoutHeader, "mytopic"); //要去checkoutheaderDto繼承
